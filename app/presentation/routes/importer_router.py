...
from app.domain.exceptions.csv_expections import CannotAddDataToDatabase, CannotProcessCSV

from ..importer.importer import TABLE_MODEL_MAP, convert_csv_to_pg_format
...
async def import_data_to_table(
    ...
    data = convert_csv_to_pg_format(csvReader)
    file.file.close()
    if not data:
